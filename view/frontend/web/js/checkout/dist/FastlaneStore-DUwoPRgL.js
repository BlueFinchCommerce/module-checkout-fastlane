...
var useFastlaneStore = defineStore('fastlaneStore', {
  ...
  actions: {
    ...
    buildJsPromises() {
      const files = [
        'https://js.braintreegateway.com/web/3.104.0-fastlane-beta.7.2/js/client.min.js',
        'https://js.braintreegateway.com/web/3.104.0-fastlane-beta.7.2/js/data-collector.min.js',
        'https://js.braintreegateway.com/web/3.104.0-fastlane-beta.7.2/js/fastlane.min.js',
      ];
      const promises = [];
